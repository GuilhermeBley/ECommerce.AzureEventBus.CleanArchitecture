...
public class LoginController : ControllerBase
{
    ...
    {
        var loginResult = await _appMediator
            .Send<LoginUserRequest, Result<LoginUserResponse>>(model, cancellationToken);
    ...
    public async Task<IActionResult> LoginAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var emailResendResult = await _appMediator
            .Send<ResendEmailConfirmationRequest, Result<ResendEmailConfirmationResponse>>(model, cancellationToken);
