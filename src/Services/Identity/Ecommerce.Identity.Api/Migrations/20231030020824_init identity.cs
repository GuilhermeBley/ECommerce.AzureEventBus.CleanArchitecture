        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwoFactoryEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdClaim = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyUsersClaims_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyUsersClaims_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyUsersClaims_CompanyId",
                table: "CompanyUsersClaims",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyUsersClaims_UserId",
                table: "CompanyUsersClaims",
                column: "UserId");
