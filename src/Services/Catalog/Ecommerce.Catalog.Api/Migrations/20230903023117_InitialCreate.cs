    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyUserClaimModel", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyUserClaimModel_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyUserClaimModel_CompanyId",
                table: "CompanyUserClaimModel",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyUserClaimModel_UserId",
                table: "CompanyUserClaimModel",
                column: "UserId");
